          ...
          <template slot-scope="props">
            ...
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="工号">
                <el-tag>{{ props.row.workID }}</el-tag>
              </el-form-item>
              <el-form-item label="性别">
                <el-tag>{{ props.row.gender }}</el-tag>
              </el-form-item>
              <el-form-item label="出生日期">
                <el-tag>{{ props.row.birthday }}</el-tag>
              </el-form-item>
              <el-form-item label="身份证号码">
                <el-tag>{{ props.row.idCard }}</el-tag>
              </el-form-item>
              <el-form-item label="婚姻状况">
                <el-tag>{{ props.row.wedlock }}</el-tag>
              </el-form-item>
              <el-form-item label="民族">
                <el-tag>{{ props.row.nation.name }}</el-tag>
              </el-form-item>


              <el-form-item label="籍贯">
                <el-tag>{{ props.row.nativePlace }}</el-tag>
              </el-form-item>
              <el-form-item label="政治面貌">
                <el-tag>{{ props.row.politicsstatus.name }}</el-tag>
              </el-form-item>
              ...
              <el-form-item label="联系地址">
                <el-tag>{{ props.row.address }}</el-tag>
              </el-form-item>
              <el-form-item label="所属部门">
                <el-tag>{{ props.row.department.name }}</el-tag>
              </el-form-item>


              <el-form-item label="职位">
                <el-tag>{{ props.row.position.name}}</el-tag>
              </el-form-item>
              ...
              <el-form-item label="最高学历">
                <el-tag>{{ props.row.tiptopDegree}}</el-tag>
              </el-form-item>
              <el-form-item label="专业">
                <el-tag>{{ props.row.specialty }}</el-tag>
              </el-form-item>
              <el-form-item label="毕业院校">
                <el-tag>{{ props.row.school }}</el-tag>
              </el-form-item>


              <el-form-item label="入职日期">
                <el-tag>{{ props.row.beginDate}}</el-tag>
              </el-form-item>
              <el-form-item label="转正日期">
                <el-tag>{{ props.row.conversionTime }}</el-tag>
              </el-form-item>
              <el-form-item label="合同起始日期">
                <el-tag>{{ props.row.beginContract }}</el-tag>
              </el-form-item>
              <el-form-item label="合同截止日期">
                <el-tag>{{ props.row.endContract}}</el-tag>
              </el-form-item>
              <el-form-item label="合同期限">
                <el-tag>{{props.row.contractTerm}}年</el-tag>
              </el-form-item>
